...
const buildingDefinitions: BuildingDefinition[] = [
  ...
  { id: 'park_landmark', tileType: TileType.PARK, displayName: 'Landmark Taman', category: 'ENVIRONMENT', maxLevel: 1, tags: ['landmark', 'ruang-publik', 'tropis'] },
];
...
export const SCENARIO_DEFINITIONS: ScenarioDefinition[] = [
  ...
  { id: 'waterfront-identity', name: 'Ikon Kota Pesisir', description: 'Bangun waterfront tropis yang menjadi ruang publik dan identitas kota.', premise: 'Kota sungai membutuhkan landmark yang menyatukan warga, wisata, dan ruang hijau.', seed: 262144, tags: ['waterfront', 'landmark', 'tropis'], targetDays: 220, constraints: ['Jaga ruang hijau publik'], events: ['Festival waterfront'], hardChoices: ['Investasi ikon atau layanan dasar'], objectives: [{ id: 'population', label: 'Capai 220 warga', target: 220 }, { id: 'landmarks', label: 'Bangun 4 landmark taman', target: 4 }, { id: 'happiness', label: 'Jaga kebahagiaan di atas 65', target: 65 }] },
];
